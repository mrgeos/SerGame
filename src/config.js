...
SG.CFG = {
  ...
  comic: {
    ...
    frames: [
      ...
      {},
      { lines: [
        { text: 'Серёжа, поспеши домой, у нас сюрприз!', x: 0.30, y: 0.18 },
        { text: 'Бегу!', x: 0.74, y: 0.42 }
      ] },
      {},
      { lines: [
        { text: 'Сергей! Нужно СРОЧНО внести несколько правок.', x: 0.30, y: 0.14 },
        { text: 'Завтра сделаю, мне надо домой — сегодня воскресенье '
              + 'и у меня день рождения!', x: 0.66, y: 0.40 },
        { text: 'Сергей, очень надо прямо сейчас!!!', x: 0.28, y: 0.70 }
      ] },
